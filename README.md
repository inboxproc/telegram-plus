...
> **Telegram Plus** — персональный форк (braintimebox) для side-load. Topics sidebar removed.

**Current build (direct IPA):** https://github.com/braintimebox/telegram-plus/actions/runs/33839370010/artifacts/9925671229

**All builds:** https://github.com/braintimebox/telegram-plus/actions — pick a green build → Artifacts → `TelegramPlus-<ver>-unsigned`
